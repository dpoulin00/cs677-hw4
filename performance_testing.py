...
if __name__ == "__main__":
    ...
    timestamp_path = Path("node_0_request_timestamps_new.csv")
    if log_path.exists():
        log_path.unlink()
    ...
    network = make_performance_test_network(num_nodes=6, start_port=start_port, max_requests=1000, nodes_to_limit=[0])
    test = 2
